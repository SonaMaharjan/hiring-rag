...
try:
    ...
    py_logging.warning(f"Google Cloud Logging unavailable locally ({e}). Using standard logger.")
...
app.title = "hiring-rag"
app.description = "API for interacting with the Agent hiring-rag"
